"""
Django settings for molecor_backend project.
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://pvco-molecor-frontend.vercel.app",
    # Add your frontend URL here for production, e.g. "https://your-frontend.vercel.app"
]

# For development only; remove/comment out in production!
...
ROOT_URLCONF = 'molecor_backend.urls'
...
WSGI_APPLICATION = 'molecor_backend.wsgi.application'
...
# Uncomment if you have a static/ folder for your own static files:
# STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]

# WhiteNoise settings (optional, but recommended for production)
# WhiteNoise settings
